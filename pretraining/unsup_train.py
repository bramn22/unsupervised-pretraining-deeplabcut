...
from pretraining.autoencoder_net import get_batch_spec
...
def train(config_yaml, displayiters, saveiters, maxiters, max_to_keep=5):
    ...
    saver = tf.train.Saver(
        max_to_keep=max_to_keep)  # selects how many snapshots are stored, see https://github.com/AlexEMG/DeepLabCut/issues/8#issuecomment-387404835
    ...
    for it in range(max_iter + 1):
        ...
        [_, loss_val, summary, _inp, _outp, _targ, _mask] = sess.run([train_op, total_loss, merged_summaries, auto.input, auto.output, auto.target, auto.mask],
